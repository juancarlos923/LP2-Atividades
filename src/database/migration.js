...
async function up() {
  ...
  CREATE TABLE empresarios (
    ...
    nome VARCHAR(50) NOT NULL,
    senha VARCHAR(200) NOT NULL CHECK(LENGTH(password) >= 8),
    imagem VARCHAR(200) NULL,
    token_verify_email VARCHAR(50),
  ...
  CREATE TABLE cliente (
    ...
    telefone VARCHAR(20) NOT NULL,
    senha VARCHAR(20) NOT NULL CHECK(LENGTH(password) >= 8),
  ...
  const sql8 = `
  INSERT INTO empresarios (nome, email, senha, imagem)
  VALUES ('Júlio Caio', 'teste@teste.com', 'teste', '/img/user.png');
  `;
  const sql9 = `
